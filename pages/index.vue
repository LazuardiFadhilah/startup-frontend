        ...
        <div class="flex flex-col md:flex-row items-center pt-10 px-5 md:px-0">
          <div class="w-full md:w-1/2 text-center md:text-left">
            ...
            <button
              ...
              class=" bg-orange-button hover:bg-green-button text-white font-semibold px-6 md:px-12 py-3 text-lg md:text-xl flex justify-start md:justify-center rounded-full"
            >
              Find a Project
            </button>
          </div>

  ...
  <div class="landing-page">
    ...
    <section class="container mx-auto pt-24">
      ...
      <div class="flex mt-3 -mx-6">
        <div
          class="card-project w-1/3 lg:h-[500px] mx-6 my-4 p-5 border border-gray-500 rounded-20"
        >
          <div class="item">
      ...
      <div class="flex mt-3 -mx-6">
        <div
          class="card-project lg:h-[500px] w-1/3 mx-6 my-4 p-5 border border-gray-500 rounded-20"
        >
          <div class="item">
            <figure class="item-image">
              <img
